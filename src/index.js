...
const keyframes = {
  ...
  'neon-flicker': {
    '0%, 19%, 21%, 23%, 25%, 54%, 56%, 100%': {
      opacity: '1',
      textShadow: '0 0 4px var(--tw-shadow-color), 0 0 11px var(--tw-shadow-color), 0 0 19px var(--tw-shadow-color)',
    },
    '20%, 24%, 55%': {
      opacity: '0.8',
      textShadow: 'none',
  ...
  function({ addBase, addComponents, addUtilities, matchUtilities, theme }) {
    ...
    addComponents({
      ...
      '.neon-text': {
        ...
        textShadow: '0 0 7px var(--vapor-neon1, #00fff5), 0 0 10px var(--vapor-neon1, #00fff5), 0 0 21px var(--vapor-neon1, #00fff5), 0 0 42px var(--vapor-neon1, #00fff5)',
      },
      
      '.neon-text-secondary': {
        color: 'var(--vapor-neon2, #ff00ff)',
        textShadow: '0 0 7px var(--vapor-neon2, #ff00ff), 0 0 10px var(--vapor-neon2, #ff00ff), 0 0 21px var(--vapor-neon2, #ff00ff), 0 0 42px var(--vapor-neon2, #ff00ff)',
      },
      ...
      '.vapor-sunset-horizon': {
        background: 'linear-gradient(180deg, #0d0221 0%, #0d0221 40%, #7b2cbf 60%, #ff2e63 80%, #ff6b35 100%)',
      },
      ...
      '.vapor-sun': {
        ...
        '&::after': {
          ...
          right: '0',
          height: '50%',
          background: 'repeating-linear-gradient(0deg, transparent, transparent 8px, #0d0221 8px, #0d0221 16px)',
        },
      },
      ...
      // Chrome text effect
      '.vapor-chrome': {
        background: 'linear-gradient(180deg, #fff 0%, #d4d4d8 25%, #fff 50%, #a1a1aa 75%, #fff 100%)',
        backgroundClip: 'text',
    ...
    addUtilities({
      ...
      '.glow': {
        boxShadow: '0 0 10px var(--vapor-glow-color, #00fff5), 0 0 20px var(--vapor-glow-color, #00fff5)',
      },
      '.glow-lg': {
        boxShadow: '0 0 20px var(--vapor-glow-color, #00fff5), 0 0 40px var(--vapor-glow-color, #00fff5), 0 0 60px var(--vapor-glow-color, #00fff5)',
      },
      '.glow-xl': {
        boxShadow: '0 0 30px var(--vapor-glow-color, #00fff5), 0 0 60px var(--vapor-glow-color, #00fff5), 0 0 90px var(--vapor-glow-color, #00fff5)',
      },
      ...
      '.text-glow': {
        textShadow: '0 0 7px var(--vapor-glow-color, #00fff5), 0 0 10px var(--vapor-glow-color, #00fff5), 0 0 21px var(--vapor-glow-color, #00fff5)',
      },
      '.text-glow-lg': {
        textShadow: '0 0 7px var(--vapor-glow-color, #00fff5), 0 0 10px var(--vapor-glow-color, #00fff5), 0 0 21px var(--vapor-glow-color, #00fff5), 0 0 42px var(--vapor-glow-color, #00fff5), 0 0 82px var(--vapor-glow-color, #00fff5)',
      },
  ...
  },
  {
    ...
    theme: {
      extend: {
        ...
        keyframes: keyframes,
        backgroundImage: {
          'vapor-gradient': 'linear-gradient(180deg, var(--vapor-neon1) 0%, var(--vapor-neon2) 100%)',
          'sunset-gradient': 'linear-gradient(180deg, #ff6b35 0%, #ff2e63 35%, #7b2cbf 70%, #1a1a2e 100%)',
        ...
        boxShadow: {
          ...
          'neon-lg': '0 0 10px var(--vapor-neon1), 0 0 40px var(--vapor-neon1), 0 0 80px var(--vapor-neon1)',
          'neon-secondary': '0 0 5px var(--vapor-neon2), 0 0 20px var(--vapor-neon2)',
          'neon-secondary-lg': '0 0 10px var(--vapor-neon2), 0 0 40px var(--vapor-neon2), 0 0 80px var(--vapor-neon2)',
        },
        dropShadow: {
